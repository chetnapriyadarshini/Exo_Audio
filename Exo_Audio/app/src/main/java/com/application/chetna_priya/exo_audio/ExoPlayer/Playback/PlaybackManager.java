...
import com.application.chetna_priya.exo_audio.ExoPlayer.Utils.WearHelper;
...
public class PlaybackManager implements Playback.Callback {
    ...
    public PlaybackManager(PlaybackServiceCallback serviceCallback, Resources resources,
                           PodcastProvider PodcastProvider, QueueManager queueManager,
                           Playback playback) {
    ...
    /**
     * Handle a request to play podcast
     */
    ...
    /**
     * Handle a request to pause podcast
     */
    ...
    /**
     * Handle a request to stop podcast
     *
    ...
    public void updatePlaybackState(String error) {
        ...
        MediaSessionCompat.QueueItem currentpodcast = mQueueManager.getCurrentPodcast();
        if (currentpodcast != null) {
            stateBuilder.setActiveQueueItemId(currentpodcast.getQueueId());
        }
    ...
    private void setCustomAction(PlaybackStateCompat.Builder stateBuilder) {
        ...
        String podcastId = MediaIDHelper.extractpodcastIDFromMediaID(mediaId);
        int favoriteIcon = mPodcastProvider.isFavorite(podcastId) ?
                R.drawable.ic_star_on : R.drawable.ic_star_off;
        Log.d(TAG, "updatePlaybackState, setting Favorite custom action of podcast "+
                podcastId+ " current favorite="+ mPodcastProvider.isFavorite(podcastId));
    ...
    private class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onCustomAction(@NonNull String action, Bundle extras) {
            if (CUSTOM_ACTION_THUMBS_UP.equals(action)) {
                ...
                if (currentpodcast != null) {
                    ...
                    if (mediaId != null) {
                        String podcastId = MediaIDHelper.extractpodcastIDFromMediaID(mediaId);
                        mPodcastProvider.setFavorite(podcastId, !mPodcastProvider.isFavorite(podcastId));
                    }
                }
        ...
        public void onPlayFromSearch(final String query, final Bundle extras) {
            ...
            if (successSearch) {
                ...
                updatePlaybackState("Could not find podcast");
            }
        }
    }
